...
class ProductoController extends Controller
{
    ...
    {
        try {
            $sucursales = Producto::with(['comercio_id', 'categoria_producto_id', 'tipo_producto_id'])->where('comercio_id', $id)->paginate(10);
    ...
    public function listarProductosIdComercioTipo(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                'negocio' => 'required|exists:comercio,id',
